...
class WheelBackgroundView @JvmOverloads constructor(
    ...
    init {
        ...
        val defaultExtraTextDistanceFromArc =
            context.resources.getDimension(R.dimen.default_wheel_background_extra_text_distance_from_arc)
        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.WheelBackgroundView, 0, 0).applyAndRecycle {
            ...
            extraTextDistanceFromArc =
                getDimension(R.styleable.WheelBackgroundView_extraTextDistanceFromArc, defaultExtraTextDistanceFromArc)
