...
sealed class StartEditAction {
    ...
    data class AutocompleteSuggestionsUpdated(val autocompleteSuggestions: List<AutocompleteSuggestion.StartEditSuggestions>) : StartEditAction()
    data class AutocompleteSuggestionTapped(val autocompleteSuggestion: AutocompleteSuggestion.StartEditSuggestions) : StartEditAction()
