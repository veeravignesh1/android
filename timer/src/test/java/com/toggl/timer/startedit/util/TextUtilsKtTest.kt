...
class TextUtilsKtTest {
    ...
    fun `substringFromTokenToPosition selects the right query`(queryTestData: QueryTestData) {
        val query = queryTestData.query
        val tokens = queryTestData.tokens
        val cursorPosition = queryTestData.cursorPosition

        val result = query.lastSubstringFromAnyTokenToPosition(tokens, cursorPosition)
    ...
    companion object {
        ...
        fun queryPickerTheory(): Stream<QueryTestData> = Stream.of(
            ...
            QueryTestData("01234 @7", charArrayOf('@'), 7, '@', ""),
            QueryTestData("01234 @7", charArrayOf('@'), 8, '@', "7"),
            QueryTestData("01234 @78901234", charArrayOf('@'), 11, '@', "7890"),
            QueryTestData("01234 @7", charArrayOf('@'), 9, '@', "7"),
            QueryTestData("01234@#7890", charArrayOf('@', '#'), 6, '@', ""),
            QueryTestData("01234@#7890", charArrayOf('@', '#'), 11, '#', "7890")
        )
    }
