...
class LoadProjectsSubscriptionTests : CoroutineTest() {
    private val repository = mockk<ProjectRepository>()
    private val subscription = LoadProjectsSubscription(repository, dispatcherProvider)
    ...
    private suspend fun LoadProjectsSubscription.testSubscribe(
